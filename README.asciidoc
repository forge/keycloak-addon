== keycloak
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The keycloak addon enables blah blah...)
...
----
<dependency>
   <groupId>org.keycloak.forge.addon</groupId>
